...
TRAINING_PARAMS="--epochs 100 --batch_size 4096 --learning_rate 1e-3 --optimizer nadam --dataset oct --model resnet9"
AL_PARAMS="--al False --labeling_budget 25000"
DP_PARAMS="--epsilon 8.0 --epsilon_al 0.0 --delta 4e-5 --max_sample_grad_norm 1.0"
