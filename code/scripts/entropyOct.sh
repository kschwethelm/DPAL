...
TRAINING_PARAMS="--epochs 30 --batch_size 4096 --learning_rate 1e-3 --optimizer nadam --dataset oct --model resnet9"
...
DP_PARAMS="--epsilon 8.0 --epsilon_al 2.0 --delta 4e-5 --max_sample_grad_norm 1.0 --aug_mult 0"
