OUTPUT_FLAGS="--output_dir output --data_root data"
SYS_FLAGS="--use_functorch False --max_physical_batch_size 120"
...
python train.py --exp_name entropy $OUTPUT_FLAGS $SYS_FLAGS $TRAINING_FLAGS $AL_FLAGS $DP_FLAGS