...
SYS_PARAMS="--use_functorch True --max_physical_batch_size 1024"
TRAINING_PARAMS="--epochs 30 --batch_size 4096 --learning_rate 1e-3 --optimizer nadam --dataset cifar10 --model resnet9 --seed 2"
...
uv run train.py --exp_name entropy $OUTPUT_PARAMS $SYS_PARAMS $TRAINING_PARAMS $AL_PARAMS $DP_PARAMS
