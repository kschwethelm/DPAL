...
def indexes_from_labels(
    in_type: FieldType, labels: List[str]
) -> Dict[str, Tuple[bool, List[int], List[int]]]:
    r"""


    Args:
        in_type (FieldType): the input field type
        labels (list): a list of strings long as the list :attr:'~nn.FieldType.representations`
