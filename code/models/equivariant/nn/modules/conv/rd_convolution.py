...
class _RdConv(EquivariantModule, ABC):
    def __init__(
        ...
        :class:`~torch-ecnn.nn.FieldType` s specified by the parameters ``in_type`` and ``out_type``.
        ...
        field types.
        Then :class:`~nn._RdConv` guarantees an equivariant mapping
        ...
        .. warning ::
            ...
            See also :meth:`nn._RdConv.train`.
        ...
        self.weights = Parameter(
            torch.zeros(self.basisexpansion.dimension()), requires_grad=True
        )
