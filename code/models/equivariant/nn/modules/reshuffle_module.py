...
from ....equivariant.nn import GSpace, GroupTensor, FieldType
...
class ReshuffleModule(EquivariantModule):
    def __init__(self, in_type: FieldType, permutation: List[int]):
        r"""
        ...
        where ``n`` is the number of fields of ``in_type`` (see :meth:`nn.FieldType.__len__`).
    ...
    def forward(self, input: GroupTensor):
        ...
        return GroupTensor(data, self.out_type, input.coords)
